    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        this.props.dispatch({
          ...
          callback: (res) =>{
            if(res === 'success'){
              router.push(`/employee/show/${values.id}`)
            ...
            <Col xl={{ span: 8, offset: 2 }} lg={{ span: 10 }} md={{ span: 24 }} sm={24}>
              <Form.Item label='入职时间'>
                {getFieldDecorator('in_time', {
                  initialValue: employee.in_time && moment(employee.in_time,'YYYY-MM-DD'),
                  ...
                  <Col lg={6} md={12} sm={24}>
                    <Form.Item label={Object.values(item[0])[0]}>
                      {getFieldDecorator(Object.keys(item[0])[0], {
                        initialValue: employee[Object.keys(item[0])[0]],
                      })(
                  ...
                  <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
                    <Form.Item label={Object.values(item[1])[0]}>
                      {getFieldDecorator(Object.keys(item[1])[0], {
                        initialValue: employee[Object.keys(item[1])[0]],
                      })(
                  ...
                  <Col xl={{ span: 8, offset: 2 }} lg={{ span: 10 }} md={{ span: 24 }} sm={24}>
                    <Form.Item label={Object.values(item[2])[0]}>
                      {getFieldDecorator(Object.keys(item[2])[0], {
                        initialValue: employee[Object.keys(item[2])[0]],
                      })(
